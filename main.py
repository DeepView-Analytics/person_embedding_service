...
from person_embedding_service.kafka_interaction.Consumer import KafkaConsumerService
from person_embedding_service.kafka_interaction.Producer import KafkaProducerService
